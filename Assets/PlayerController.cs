...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(JumpSensor.TouchedCount > 0)
        {
            if (Input.GetKey(KeyCode.W)) {  Walksound.SetActive(true); }
            else if (Input.GetKey(KeyCode.S)) {  Walksound.SetActive(true); }
            else if (Input.GetKey(KeyCode.D)) {  Walksound.SetActive(true); }
            else if (Input.GetKey(KeyCode.A)) {  Walksound.SetActive(true); }
            else { Walksound.SetActive(false); }
        }
        if (JumpSensor.TouchedCount <= 0)
        {
